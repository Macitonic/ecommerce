...
<head>
    ...
    <style>
        .smartwatch-card {
            background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("https://i.pinimg.com/1200x/00/22/a9/0022a9eb283ba672c92cdc2db32de556.jpg") no-repeat center/cover;
            width: 250px;
            height: 280px;
