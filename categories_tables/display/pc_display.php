...
<body>
    ...
    <section class="card-container">
        ...
        ?>
            <div class="pc-card" style="cursor: pointer;" onclick="location.href='../../details_page.php'">
                <div class="image">
                ...
                <div class="card-content">
                    ...
                    <button type="button" onclick="event.stopPropagation(); window.location='../../cart.php?add_type=pc&add_id=<?php echo $row['id']; ?>'">Add to Cart</button>
                </div>
            </div>
        <?php }; ?>
    </section>
